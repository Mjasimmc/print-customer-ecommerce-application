  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.navHeader}>
        ...
        <span style={{ fontWeight: 700, fontSize: '0.9rem', color: 'var(--color-text-main)' }}>Service Requirements & Specs</span>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        <div className={styles.detailsHeader}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--color-text-muted)', marginTop: '0.25rem', lineHeight: 1.4 }}>{product.description}</p>
        </div>
        ...
        <div className={styles.optionSection}>
          ...
          <div className={styles.radioGroup}>
            {product.specifications.materials.map((mat) => (
              ...
              >
                <span style={{ fontWeight: 700, fontSize: '0.875rem' }}>{mat}</span>
                <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>Included</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className={styles.optionSection}>
          ...
          <div className={styles.radioGroup}>
            {product.specifications.finishes.map((fin) => (
              ...
              >
                <span style={{ fontWeight: 700, fontSize: '0.875rem' }}>{fin}</span>
                <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>Included</span>
              </div>
            ))}
          </div>
        ...
        <div className={styles.optionSection}>
          ...
          <div className={styles.qtyGrid}>
            {[
              ...
              >
                <span style={{ fontWeight: 800, fontSize: '1rem' }}>{q.qty}</span>
