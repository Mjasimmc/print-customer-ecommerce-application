...
import { Button, Input } from '@print-delivery/ui';
    ...
    <div>
      <div className={styles.container}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <span style={{ fontSize: '0.8rem', color: '#2563eb', cursor: 'pointer' }} onClick={() => navigate('/search')}>
            + Add Services
          </span>
        </div>
        ...
        <div className={styles.summaryCard}>
          ...
          <Button variant="primary" size="lg" style={{ marginTop: '0.5rem' }} onClick={() => navigate('/checkout')}>
            Proceed to Checkout ➔
          </Button>
        </div>
      </div>
