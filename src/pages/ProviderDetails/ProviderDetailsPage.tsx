...
import styles from './ProviderDetailsPage.module.scss';
  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        <button style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: '0.9rem', color: '#2563eb', fontWeight: 600, width: 'fit-content' }} onClick={() => navigate(-1)}>
          ← Back to Providers
        </button>
