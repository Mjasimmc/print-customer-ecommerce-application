...
export const HomePage: React.FC = () => {
  ...
  const activeOrder = MOCK_ORDERS[0]; // Active production order
  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        ...
        {activeOrder && (
          <div className={styles.activeOrderBanner} onClick={() => navigate(`/tracking/${activeOrder.id}`)}>
        ...
        <section>
          <div className={styles.sectionHeader}>
            ...
            <span className={styles.seeAll} onClick={() => navigate('/search')}>All Categories ➔</span>
          </div>
        ...
        <section>
          <div className={styles.sectionHeader}>
            ...
            <span className={styles.seeAll} onClick={() => navigate('/search')}>View All ➔</span>
          </div>
        ...
        <section>
          <div className={styles.sectionHeader}>
            ...
            <span className={styles.seeAll} onClick={() => navigate('/search')}>Browse All ➔</span>
          </div>
